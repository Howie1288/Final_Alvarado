...
class Asignacion extends Conexion
{
    ...
    {
        $sql = "INSERT INTO asignacion_programadores (asignacion_id_aplicacion, asignacion_id_programador, ) values('$this->asignacion_id_aplicacion','$this->asignacion_id_programador', '$this->')";
    ...
    {
        $sql = "SELECT * from aplicaciones where  = 1 ";
    ...
    {
        $sql = "UPDATE aplicaciones SET asignacion_id_aplicacion = '$this->asignacion_id_aplicacion', asignacion_id_programador = $this->asignacion_id_programador where asignacion_id= $this->asignacion_id";
    ...
    {
        $sql = "UPDATE aplicaciones SET asignacion_id = 0 where  asignacion_id = $this-> asignacion_id ";
